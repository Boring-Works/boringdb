    ...
    translation: {
        ...
        export_diagram_dialog: {
            ...
            error: {
                ...
                description:
                    'cody@getboring.io حدث خطأ ما. هل تحتاج إلى مساعدة؟',
            },
        },
        import_diagram_dialog: {
            ...
            error: {
                ...
                description:
                    'cody@getboring.io و المحاولة مرة اخرى. هل تحتاج إلى المساعدة؟ JSON غير صالح. يرجى التحقق من JSON الرسم البياني',
            },
        },
        import_dbml_dialog: {
            // TODO: Translate
